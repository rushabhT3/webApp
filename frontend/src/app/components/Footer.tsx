...
function Footer() {
  const socialLinks = [
    ...
    },
    {
      ...
      svgPath: "M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01",
      additionalSvg: <circle cx="4" cy="4" r="2" stroke="none"></circle>,
    },
    {
      ...
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          {socialLinks.map((link) => (
            <a key={link.href} href={link.href} className="ml-3 text-gray-500">
              <svg
                fill="currentColor"
                strokeLinecap="round"
